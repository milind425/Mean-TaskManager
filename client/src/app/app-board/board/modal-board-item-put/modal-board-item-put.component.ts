...
@Component ({
	selector: 'app-modal-board-item-put',
	templateUrl: './modal-board-item-put.component.html',
	styleUrls: ['./modal-board-item-put.component.css']
})
export class ModalBoardItemPutComponent {
	
	constructor(public dialogRef: MatDialogRef<ModalBoardItemPutComponent>,
